...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "BROWSE FOR THE STUDENT LIST TEXT FILE GATHERED FROM PEOPLESOFT AND HIT THE PROCES" & _
            "S BUTTON TO LAUNCH THE OPERATION"
        '
        'ButtonFolderBrowse
        '
        ...
        Me.Button_Pause1.UseVisualStyleBackColor = False
        ...
        Me.Button_ExitThread.UseVisualStyleBackColor = False
...
#End Region
    ...
    Private Sub Main_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Virtual Book CSV Generator (Build " & Format(My.Application.Info.Version.Major, "0000") & Format(My.Application.Info.Version.Minor, "00") & Format(My.Application.Info.Version.Build, "00") & "." & Format(My.Application.Info.Version.Revision, "00") & ")"
